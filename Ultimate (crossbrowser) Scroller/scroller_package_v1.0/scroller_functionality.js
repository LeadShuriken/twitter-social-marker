...
var Scroller = function(elem, adjustable, banner_element){
    ...
    this.MouseWheelHandler = function(e) {
        ...
        that.legal.scrollTop -= delta*(that.scrollTrack.offsetHeight/10);
        return false;
    };
    ...
    this.clickMove = function(event) {
        ...
        if(target.classList.contains("up")){
            that.legal.scrollTop -= (that.scrollTrack.offsetHeight/5);
    ...
    (function() {
        ...
        that.holder = (document.getElementById(banner_element)) ? document.getElementById(banner_element) : that.scroller_package;
